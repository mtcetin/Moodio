    ...
    renderCoverflow() {
        ...
        return (
            <ScrollView pagingEnabled={true} horizontal={true}>
                <CoverFlowItem page_width={D.width} width={width} height={height} source={require('./images/1.jpg')}/>
                <CoverFlowItem page_width={D.width} width={width} height={height} source={require('./images/2.jpeg')}/>
                <CoverFlowItem page_width={D.width} width={width} height={height} source={require('./images/3.jpg')}/>
            </ScrollView>
        )
    }
